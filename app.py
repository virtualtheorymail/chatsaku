...
def generate_laporan_harian(nomor_wa):
    ...
    laporan = f"""💚 *Hai! Ini kabar keuanganmu hari ini*

📅 {hari_ini.strftime("%d %B %Y")}

Yuk, lihat sebentar uangmu hari ini 👇
...
🟢 *Yang masuk hari ini*
{detail_masuk or "Belum ada uang yang masuk hari ini."}

🔴 *Yang keluar hari ini*
{detail_keluar or "Belum ada pengeluaran hari ini."}

🟠 *Hutang yang dicatat*
{detail_hutang or "Belum ada hutang baru hari ini."}

🔵 *Piutang yang dicatat*
{detail_piutang or "Belum ada piutang baru hari ini."}

━━━━━━━━━━━━━━━━━━

👀 *Mau lihat lebih lengkap?*

Buka catatan keuanganmu di sini:
🌐 {Link}

_Link aktif selama 30 menit._

Sedikit demi sedikit dicatat, lama-lama kamu jadi tahu uangmu sebenarnya pergi ke mana. 💚

*ChatSaku • Teman mencatat dan memahami keuanganmu*
"""
    return laporan
...
def kirim_reminder_harian():
    ...
    with app.app_context():
        ...
        try:
            ...
            # ======================================
            # KELOMPOKKAN REMINDER PER NOMOR WA
            # ======================================
            ...
            for reminder in reminders:
                ...
                if nomor_wa not in reminder_users:
                    reminder_users[nomor_wa] = []

                reminder_users[nomor_wa].append(
                    reminder
                )
            ...
            for nomor_wa, user_reminders in reminder_users.items():
...
def transaksi_summary():
    ...
    #
    # Jadi:
    # saldo = seluruh pemasukan - seluruh pengeluaran
    # =====================================================
    ...
    #
    # maka transaksi difilter sesuai tanggal.
    #
    # Jika tidak dikirim:
    ...
    for trx in all_data[:10]:
        ...
        transaksi_terbaru.append({
            ...
            # Sama seperti dashboard Railway
            "saldo": int(saldo)
    ...
    # TREND
    #
    # MENGIKUTI LOGIC DASHBOARD RAILWAY
    # =====================================================
    ...
    return jsonify({
        ...
        # Periode sekarang hanya informasi,
        # bukan filter summary
        "periode": periode,

        # =================================================
        # COMPATIBILITY LANGSUNG
        #
        # Supaya HTML yang membaca:
        # data.saldo
        # data.masuk
        # data.keluar
        #
...
def create_transaksi():
    ...
    if tanggal:
        ...
        try:
            ...
            tanggal_obj = datetime.fromisoformat(
                tanggal
            )
    ...
    transaksi = Transaksi(
        ...
        subkategori=subkategori or None,
    ...
    return jsonify({
        ...
        "data": {
            ...
            "subkategori": transaksi.subkategori,
...
def update_transaksi(transaksi_id):
    ...
    if tanggal:
        ...
        try:
            ...
            transaksi.tanggal = datetime.fromisoformat(
                tanggal
            )
